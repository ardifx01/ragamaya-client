  ...
  return (
    <motion.div
      animate={{
        ...
        backgroundColor: visible ? "rgba(255, 255, 255, 0.1)" : "rgba(255, 255, 255, 0.05)",
        borderColor: visible ? "rgba(255, 255, 255, 0.2)" : "rgba(255, 255, 255, 0.1)",
        boxShadow: visible
          ? "0 0 24px rgba(0, 0, 0, 0.3), 0 1px 1px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.1), 0 0 4px rgba(0, 0, 0, 0.4), 0 16px 68px rgba(0, 0, 0, 0.3), 0 1px 0 rgba(255, 255, 255, 0.2) inset"
          : "0 0 12px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.1), 0 1px 0 rgba(255, 255, 255, 0.1) inset",
      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-large bg-white/20 backdrop-blur-sm"
            />
          )}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      animate={{
        backdropFilter: "blur(20px)",
        backgroundColor: visible ? "rgba(255, 255, 255, 0.08)" : "rgba(255, 255, 255, 0.03)",
        borderColor: visible ? "rgba(255, 255, 255, 0.15)" : "rgba(255, 255, 255, 0.08)",
        boxShadow: visible
          ? "0 8px 32px rgba(0, 0, 0, 0.4), 0 2px 8px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.1)"
          : "0 4px 16px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.05), inset 0 1px 0 rgba(255, 255, 255, 0.08)",
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-large border border-white/10 bg-black/60 px-4 py-6 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.4),_0_2px_8px_rgba(0,0,0,0.2),_0_0_0_1px_rgba(255,255,255,0.08),_inset_0_1px_0_rgba(255,255,255,0.1)]",
            className,
          )}
        >
          {children}
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-large text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center"
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent shadow-none text-white border border-white/30 hover:border-white/50",
    dark: "bg-black text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    gradient:
      "bg-gradient-to-b from-blue-500 to-blue-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
    glass:
      "bg-white/10 text-white border border-white/20 backdrop-blur-md shadow-[0_0_12px_rgba(0,0,0,0.2),_0_0_0_1px_rgba(255,255,255,0.1),_0_1px_0_rgba(255,255,255,0.1)_inset]",
  }
