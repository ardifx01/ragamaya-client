...
const PaymentStatusBanner = ({ status }) => {
    if (status === "pending") {
        return (
            <div className={`bg-gradient-to-tl from-amber-500 to-amber-300 w-full pb-10 flex flex-col items-center justify-center`}>
                <Player
        ...
        return (
            <div className={`bg-gradient-to-tl from-sky-600 to-sky-400 w-full pb-10 flex flex-col items-center justify-center`}>
                <Player
        ...
        return (
            <div className={`bg-gradient-to-tl from-rose-700 to-rose-500 w-full pb-10 flex flex-col items-center justify-center`}>
                <Player
                ...
                <div>
                    ...
                    <p className='w-11/12 mx-auto text-center text-white'>Pembayaran telah kadaluarsa, pemesanan tiket dibatalkan</p>
                </div>
            </div>
        )
    } else if (status === "settlement") {
        return (
            <div className={`bg-gradient-to-tl from-violet-500 to-violet-300 w-full pb-10 flex flex-col items-center justify-center`}>
                <Player
