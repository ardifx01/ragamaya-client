...
import { ShoppingCart, Download, FileImage, Star, Info } from 'lucide-react';
        ...
        >
                            ...
                            product.digital_files.map((file, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p className="text-left font-medium text-white">{file.description}</p>
                                        <p className="text-left text-sm text-gray-400">Format: {file.extension.toUpperCase()}</p>
                                    </div>
            ...
            {!product.is_owned ? (
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.6 }}
                    className="bg-gradient-to-r from-green-500/40 to-green-500/30 backdrop-blur-sm rounded-2xl p-6 border border-green-500/50"
                >
